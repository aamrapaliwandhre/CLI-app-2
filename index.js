...
const userName = readlineSync.question(`Enter your name to begin the Quiz: `);
...
const questionsBank = [
  {
    question : 
    `Which is the latest entity to start a Payments Bank in India?`,

    options : ["Aditya Birla Idea", "Tata Payments Bank", "Reliance Jio", "Mahindra"],

    answer : "Aditya Birla Idea",
...

  {
    ...
    options : ["Airtel","Jio", "Idea", "Vodafone"],
  ...
  },
 {
    ...
    options : [ "National Payments Corporation of India (NPCI)",
